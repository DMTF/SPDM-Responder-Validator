...
Assertion 4.3.5:
    SpdmMessage.Param2.ProvisionedSlotMask.bit_0 == 1
...
Assertion 4.3.9:
    if (MULTI_KEY_CONN_RSP == true), then
        SpdmMessage.CertificateInfo[0].CertModel is in {DeviceCert, AliasCert}
        for each i in [1, SlotCount-1]: SpdmMessage.CertificateInfo[i].CertModel is in {None, DeviceCert, AliasCert, GenericCert}
