...
Steps:
1. Requester -> GET_CERTIFICATE {SPDMVersion=NegotiatedVersion, Param1.SlotID=ValidSlotID[i], Param2=0, Offset=0, Length=0x1000}
...
3. Requester -> GET_CERTIFICATE {SPDMVersion=NegotiatedVersion, Param1.SlotID=ValidSlotID[i], Param2=0, Offset=NextOffset, Length=0x1000}, while SpdmMessage.RemainderLength != 0
...
Steps:
1. Requester -> GET_CERTIFICATE {SPDMVersion=NegotiatedVersion, Param1.SlotID=InvalidSlotID[i], Param2=0, Offset=0, Length=0x1000}
2. SpdmMessage <- Responder
...
Description: SPDM responder shall return valid CERTIFICATE, if it receives a GET_CERTIFICATE in a DHE session.
...
Steps:
1. Requester -> GET_CERTIFICATE {SPDMVersion=NegotiatedVersion, Param1.SlotID=ValidSlotID[i], Param2=0, Offset=0, Length=0x1000} in session-X
...
3. Requester -> GET_CERTIFICATE {SPDMVersion=NegotiatedVersion, Param1.SlotID=ValidSlotID[i], Param2=0, Offset=NextOffset, Length=0x1000}, while SpdmMessage.RemainderLength != 0 in session-X
...
Description: SPDM responder shall return ERROR(UnexpectedRequest), if it receives a GET_CERTIFICATE in a DHE session handshake.
