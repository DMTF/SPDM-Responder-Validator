...
3. Requester -> GET_CERTIFICATE {SPDMVersion=NegotiatedVersion, Param1.SlotID=0, Param2=0, Offset=0, Length=0x400}
4. SpdmMessage <- Responder

Assertion 5.4.*.

5. Requester -> GET_CERTIFICATE {SPDMVersion=NegotiatedVersion, Param1.SlotID=0, Param2=0, Offset=0, Length=0}
