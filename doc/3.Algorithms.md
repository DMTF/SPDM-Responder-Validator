...
Steps:
1. Requester -> NEGOTIATE_ALGORITHMS {SPDMVersion=0x13, Param1.NumOfAlgoStruct=4, Param2=0, MeasurementSpecification=DMTF, MELSpecification=DMTF, OtherParamsSupport=OpaqueDataFmt1, ResponderMultiKeyConn=(MULTI_KEY_CAP!=0), BaseAsymAlgo=TPM_ALG_RSASSA_2048|TPM_ALG_RSAPSS_2048|TPM_ALG_RSASSA_3072|TPM_ALG_RSAPSS_3072|TPM_ALG_ECDSA_ECC_NIST_P256|TPM_ALG_RSASSA_4096|TPM_ALG_RSAPSS_4096|TPM_ALG_ECDSA_ECC_NIST_P384|TPM_ALG_ECDSA_ECC_NIST_P521|TPM_ALG_SM2_ECC_SM2_P256|EdDSA_ed25519|EdDSA_ed448, BaseHashAlgo=TPM_ALG_SHA_256|TPM_ALG_SHA_384|TPM_ALG_SHA_512|TPM_ALG_SHA3_256|TPM_ALG_SHA3_384|TPM_ALG_SHA3_512|TPM_ALG_SM3_256, ExtAsymCount=0, ExtHashCount=0, ReqAlgStruct[0]{AlgType=DHE, AlgSupported=ffdhe2048|ffdhe3072|ffdhe4096|secp256r1|secp384r1|secp521r1|SM2_P256}, ReqAlgStruct[1]{AlgType=AEAD, AlgSupported=AES-128-GCM|AES-256-GCM|CHACHA20_POLY1305|AEAD_SM4_GCM}, ReqAlgStruct[2]{AlgType=ReqBaseAsymAlg, AlgSupported=TPM_ALG_RSASSA_2048|TPM_ALG_RSAPSS_2048|TPM_ALG_RSASSA_3072|TPM_ALG_RSAPSS_3072|TPM_ALG_ECDSA_ECC_NIST_P256|TPM_ALG_RSASSA_4096|TPM_ALG_RSAPSS_4096|TPM_ALG_ECDSA_ECC_NIST_P384|TPM_ALG_ECDSA_ECC_NIST_P521|TPM_ALG_SM2_ECC_SM2_P256|EdDSA_ed25519|EdDSA_ed448}, ReqAlgStruct[3]{AlgType=KeySchedule, AlgSupported=SPDM} }
2. SpdmMessage <- Responder
...
Assertion 3.8.9:
    SpdmMessage.BaseAsymSel only has one bit at most.
    if (CHAL_CAP == 1 || MEAS_CAP == 2 || KEY_EX_CAP == 1 || EP_INFO_CAP == 2) then (BaseAsymSel == one of {TPM_ALG_RSASSA_2048, TPM_ALG_RSAPSS_2048, TPM_ALG_RSASSA_3072, TPM_ALG_RSAPSS_3072, TPM_ALG_ECDSA_ECC_NIST_P256, TPM_ALG_RSASSA_4096, TPM_ALG_RSAPSS_4096, TPM_ALG_ECDSA_ECC_NIST_P384, TPM_ALG_ECDSA_ECC_NIST_P521, TPM_ALG_SM2_ECC_SM2_P256, EdDSA_ed25519, EdDSA_ed448})
    if (CHAL_CAP == 0 && MEAS_CAP != 2 && KEY_EX_CAP == 0 && EP_INFO_CAP != 2) then (BaseAsymSel == 0)

Assertion 3.8.10:
    SpdmMessage.BaseHashSel only has one bit at most.
    if (CHAL_CAP == 1 || MEAS_CAP == 2 || KEY_EX_CAP == 1 || EP_INFO_CAP == 2 || PSK_EX_CAP != 0) then (BaseHashSel == one of {TPM_ALG_SHA_256, TPM_ALG_SHA_384, TPM_ALG_SHA_512, TPM_ALG_SHA3_256, TPM_ALG_SHA3_384, TPM_ALG_SHA3_512, TPM_ALG_SM3_256})
    if (CHAL_CAP == 0 && MEAS_CAP != 2 && KEY_EX_CAP == 0 && EP_INFO_CAP != 2 && PSK_EX_CAP == 0) then (BaseHashSel == 0)
...
Steps:
1. Requester -> NEGOTIATE_ALGORITHMS {SPDMVersion=0x14, Param1.NumOfAlgoStruct=6, Param2=0, MeasurementSpecification=DMTF, MELSpecification=DMTF, OtherParamsSupport=OpaqueDataFmt1, ResponderMultiKeyConn=(MULTI_KEY_CAP!=0), BaseAsymAlgo=TPM_ALG_RSASSA_2048|TPM_ALG_RSAPSS_2048|TPM_ALG_RSASSA_3072|TPM_ALG_RSAPSS_3072|TPM_ALG_ECDSA_ECC_NIST_P256|TPM_ALG_RSASSA_4096|TPM_ALG_RSAPSS_4096|TPM_ALG_ECDSA_ECC_NIST_P384|TPM_ALG_ECDSA_ECC_NIST_P521|TPM_ALG_SM2_ECC_SM2_P256|EdDSA_ed25519|EdDSA_ed448, BaseHashAlgo=TPM_ALG_SHA_256|TPM_ALG_SHA_384|TPM_ALG_SHA_512|TPM_ALG_SHA3_256|TPM_ALG_SHA3_384|TPM_ALG_SHA3_512|TPM_ALG_SM3_256, PqcAsymAlgo=ML-DSA-44|ML-DSA-65|ML-DSA-87|SLH-DSA-SHA2-128s|SLH-DSA-SHAKE-128s|SLH-DSA-SHA2-128f|SLH-DSA-SHAKE-128f|SLH-DSA-SHA2-192s|SLH-DSA-SHAKE-192s|SLH-DSA-SHA2-192f|SLH-DSA-SHAKE-192f|SLH-DSA-SHA2-256s|SLH-DSA-SHAKE-256s|SLH-DSA-SHA2-256f|SLH-DSA-SHAKE-256f, ExtAsymCount=0, ExtHashCount=0, ReqAlgStruct[0]{AlgType=DHE, AlgSupported=ffdhe2048|ffdhe3072|ffdhe4096|secp256r1|secp384r1|secp521r1|SM2_P256}, ReqAlgStruct[1]{AlgType=AEAD, AlgSupported=AES-128-GCM|AES-256-GCM|CHACHA20_POLY1305|AEAD_SM4_GCM}, ReqAlgStruct[2]{AlgType=ReqBaseAsymAlg, AlgSupported=TPM_ALG_RSASSA_2048|TPM_ALG_RSAPSS_2048|TPM_ALG_RSASSA_3072|TPM_ALG_RSAPSS_3072|TPM_ALG_ECDSA_ECC_NIST_P256|TPM_ALG_RSASSA_4096|TPM_ALG_RSAPSS_4096|TPM_ALG_ECDSA_ECC_NIST_P384|TPM_ALG_ECDSA_ECC_NIST_P521|TPM_ALG_SM2_ECC_SM2_P256|EdDSA_ed25519|EdDSA_ed448}, ReqAlgStruct[3]{AlgType=KeySchedule, AlgSupported=SPDM}, ReqAlgStruct[4]{AlgType=ReqPqcAsymAlg, AlgSupported=ML-DSA-44|ML-DSA-65|ML-DSA-87|SLH-DSA-SHA2-128s|SLH-DSA-SHAKE-128s|SLH-DSA-SHA2-128f|SLH-DSA-SHAKE-128f|SLH-DSA-SHA2-192s|SLH-DSA-SHAKE-192s|SLH-DSA-SHA2-192f|SLH-DSA-SHAKE-192f|SLH-DSA-SHA2-256s|SLH-DSA-SHAKE-256s|SLH-DSA-SHA2-256f|SLH-DSA-SHAKE-256f}, ReqAlgStruct[5]{AlgType=KEMAlg, AlgSupported=ML-KEM-512|ML-KEM-768|ML-KEM-1024} }
2. SpdmMessage <- Responder
...
Assertion 3.9.4:
    SpdmMessage.Length <= sizeof(SpdmMessage)
    SpdmMessage.Length == offset(ALGORITHMS_1.4, ExtAsymSel) + 4 * SpdmMessage.ExtAsymSelCount + 4 * SpdmMessage.ExtHashSelCount + SpdmMessage.Param1 * sizeof(AlgStructSize)
...
Assertion 3.9.9:
    ...
    The total number of bits set in BaseAsymSel and PqcAsymSel shall be no more than one.
    if (CHAL_CAP == 1 || MEAS_CAP == 2 || KEY_EX_CAP == 1 || EP_INFO_CAP == 2) then (exactly one bit is set across BaseAsymSel and PqcAsymSel)
    if (BaseAsymSel != 0) then (BaseAsymSel == one of {TPM_ALG_RSASSA_2048, TPM_ALG_RSAPSS_2048, TPM_ALG_RSASSA_3072, TPM_ALG_RSAPSS_3072, TPM_ALG_ECDSA_ECC_NIST_P256, TPM_ALG_RSASSA_4096, TPM_ALG_RSAPSS_4096, TPM_ALG_ECDSA_ECC_NIST_P384, TPM_ALG_ECDSA_ECC_NIST_P521, TPM_ALG_SM2_ECC_SM2_P256, EdDSA_ed25519, EdDSA_ed448})
    if (PqcAsymSel != 0) then (PqcAsymSel == one of {ML-DSA-44, ML-DSA-65, ML-DSA-87, SLH-DSA-SHA2-128s, SLH-DSA-SHAKE-128s, SLH-DSA-SHA2-128f, SLH-DSA-SHAKE-128f, SLH-DSA-SHA2-192s, SLH-DSA-SHAKE-192s, SLH-DSA-SHA2-192f, SLH-DSA-SHAKE-192f, SLH-DSA-SHA2-256s, SLH-DSA-SHAKE-256s, SLH-DSA-SHA2-256f, SLH-DSA-SHAKE-256f})
    if (CHAL_CAP == 0 && MEAS_CAP != 2 && KEY_EX_CAP == 0 && EP_INFO_CAP != 2) then (BaseAsymSel == 0) && (PqcAsymSel == 0)
...
Assertion 3.9.11:
    ...
    SpdmMessage.AlgStructure[i].AlgType is in {DHE, AEAD, ReqBaseAsymAlg, KeySchedule, ReqPqcAsymAlg, KEMAlg}, monotonically increasing and no duplication. (Table 26)

Assertion 3.9.12:
    for AlgType in {DHE, AEAD, ReqBaseAsymAlg, KeySchedule}: SpdmMessage.AlgStructure[i].AlgCount == 0x20
    for AlgType in {ReqPqcAsymAlg, KEMAlg}: SpdmMessage.AlgStructure[i].AlgCount (Bit[7:4]>=1, Bit[3:0]=0)

Assertion 3.9.13:
    SpdmMessage.AlgStructure[DHE_index] only has one bit at most.
    SpdmMessage.AlgStructure[KEMAlg_index] only has one bit at most.
    The total number of bits set in AlgStructure[DHE_index].AlgSupported and AlgStructure[KEMAlg_index].AlgSupported shall be no more than one.
    if (KEY_EX_CAP == 1) then (exactly one bit is set across AlgStructure[DHE_index].AlgSupported and AlgStructure[KEMAlg_index].AlgSupported)
    if (AlgStructure[DHE_index].AlgSupported != 0) then it == one of {ffdhe2048, ffdhe3072, ffdhe4096, secp256r1, secp384r1, secp521r1, SM2_P256}
    if (AlgStructure[KEMAlg_index].AlgSupported != 0) then it == one of {ML_KEM_512, ML_KEM_68, ML_KEM_102}
    if (KEY_EX_CAP == 0) then SpdmMessage.AlgStructure[DHE_index].AlgSupported == 0, or it is absent
...
Assertion 3.9.15:
    SpdmMessage.AlgStructure[ReqBaseAsymAlg_index] only has one bit at most.
    SpdmMessage.AlgStructure[ReqPqcAsymAlg_index] only has one bit at most. (Table 31)
    The total number of bits set in AlgStructure[ReqBaseAsymAlg_index].AlgSupported and AlgStructure[ReqPqcAsymAlg_index].AlgSupported shall be no more than one.
    if (MUT_AUTH_CAP == 1) then (exactly one bit is set across AlgStructure[ReqBaseAsymAlg_index].AlgSupported and AlgStructure[ReqPqcAsymAlg_index].AlgSupported)
    if (AlgStructure[ReqBaseAsymAlg_index].AlgSupported != 0) then it == one of {TPM_ALG_RSASSA_2048, TPM_ALG_RSAPSS_2048, TPM_ALG_RSASSA_3072, TPM_ALG_RSAPSS_3072, TPM_ALG_ECDSA_ECC_NIST_P256, TPM_ALG_RSASSA_4096, TPM_ALG_RSAPSS_4096, TPM_ALG_ECDSA_ECC_NIST_P384, TPM_ALG_ECDSA_ECC_NIST_P521, TPM_ALG_SM2_ECC_SM2_P256, EdDSA_ed25519, EdDSA_ed448}
    if (AlgStructure[ReqPqcAsymAlg_index].AlgSupported != 0) then it == one of {ML-DSA-44, ML-DSA-65, ML-DSA-87, SLH-DSA-SHA2-128s, SLH-DSA-SHAKE-128s, SLH-DSA-SHA2-128f, SLH-DSA-SHAKE-128f, SLH-DSA-SHA2-192s, SLH-DSA-SHAKE-192s, SLH-DSA-SHA2-192f, SLH-DSA-SHAKE-192f, SLH-DSA-SHA2-256s, SLH-DSA-SHAKE-256s, SLH-DSA-SHA2-256f, SLH-DSA-SHAKE-256f}
    if (MUT_AUTH_CAP == 0) then SpdmMessage.AlgStructure[ReqBaseAsymAlg_index].AlgSupported == 0, or it is absent
