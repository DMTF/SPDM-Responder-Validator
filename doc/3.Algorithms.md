...
13. Requester -> NEGOTIATE_ALGORITHMS {SPDMVersion=NegotiatedVersion, ExtAlgCount=21, ...} -- if NegotiatedVersion=1.1+
...
Assertion 3.5.11:
    SpdmMessage.AlgStructure[i].AlgType is in {DHE, AEAD, ReqBaseAsymAlg, KeySchedule}
...
Assertion 3.6.9:
    SpdmMessage.BaseAsymSel only has one bit at most.
    if (CHAL_CAP == 1 || MEAS_CAP == 2) then (BaseAsymSel == one of {TPM_ALG_RSASSA_2048, TPM_ALG_RSAPSS_2048, TPM_ALG_RSASSA_3072, TPM_ALG_RSAPSS_3072, TPM_ALG_ECDSA_ECC_NIST_P256, TPM_ALG_RSASSA_4096, TPM_ALG_RSAPSS_4096, TPM_ALG_ECDSA_ECC_NIST_P384, TPM_ALG_ECDSA_ECC_NIST_P521, TPM_ALG_SM2_ECC_SM2_P256, EdDSA_ed25519, EdDSA_ed448})
    if (CHAL_CAP == 0 && MEAS_CAP != 2) then (BaseAsymSel == 0)

Assertion 3.6.10:
    SpdmMessage.BaseHashSel only has one bit at most.
    if (CHAL_CAP == 1 || MEAS_CAP == 2) then (BaseHashSel == one of {TPM_ALG_SHA_256, TPM_ALG_SHA_384, TPM_ALG_SHA_512, TPM_ALG_SHA3_256, TPM_ALG_SHA3_384, TPM_ALG_SHA3_512, TPM_ALG_SM3_256})
    if (CHAL_CAP == 0 && MEAS_CAP != 2) then (BaseHashSel == 0)
...
Assertion 3.6.17:
    ...
    if (KEY_EX_CAP == 0 && PSK_CAP == 0) then OtherParamsSupport.OpaqueDataFmt == 0
