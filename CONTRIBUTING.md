# Contributing to SPDM-Responder-Validator

Thank you for your interest in contributing to SPDM-Responder-Validator, the
DMTF tool for validating [SPDM](https://www.dmtf.org/standards/spdm) responder
implementations against the specification.
...
SPDM-Responder-Validator is licensed under the BSD 3-Clause License (see
