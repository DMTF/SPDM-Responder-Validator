...
#define   SPDM_RESPONDER_TEST_CASE_DIGESTS_SUCCESS_13                            3
...
#define   SPDM_RESPONDER_TEST_CASE_CERTIFICATE_LARGE_RESP                             7
#define   SPDM_RESPONDER_TEST_CASE_CERTIFICATE_NO_PARTIAL_CHAIN                       8
#define   SPDM_RESPONDER_TEST_CASE_CERTIFICATE_NO_PARTIAL_CHAIN_LARGE                 9
