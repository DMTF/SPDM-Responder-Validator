...
void spdm_test_case_algorithms_unexpected_request (void *test_context)
{
    ...
    if (version >= SPDM_MESSAGE_VERSION_12) {
      spdm_request.struct_table[1].alg_supported |= SPDM_ALGORITHMS_AEAD_CIPHER_SUITE_AEAD_SM4_GCM;
    }
    ...
    spdm_request.struct_table[2].alg_supported = SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSASSA_2048 |
                                                 SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSAPSS_2048 |
                                                 SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSASSA_3072 |
                                                 SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSAPSS_3072 |
                                                 SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_ECDSA_ECC_NIST_P256 |
                                                 ...
                                                 SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_ECDSA_ECC_NIST_P521;
    if (version >= SPDM_MESSAGE_VERSION_12) {
      spdm_request.struct_table[2].alg_supported |= SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_SM2_ECC_SM2_P256 |
                                                    SPDM_ALGORITHMS_BASE_ASYM_ALGO_EDDSA_ED25519 |
                                                    SPDM_ALGORITHMS_BASE_ASYM_ALGO_EDDSA_ED448;
    }
    ...
    if (LIBSPDM_STATUS_IS_ERROR(status)) {
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST, COMMON_TEST_ID_END,
            COMMON_TEST_RESULT_NOT_TESTED, "send/receive failure");
        return ;
    }
    ...
    common_test_record_test_assertion (
        SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST, 1,
        test_result, "response size - %d", spdm_response_size);
    if (test_result == COMMON_TEST_RESULT_FAIL) {
        return ;
    }
    ...
    common_test_record_test_assertion (
        SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST, 2,
        test_result, "response code - 0x%02x", spdm_response->header.request_response_code);
    if (test_result == COMMON_TEST_RESULT_FAIL) {
        return ;
    }
    ...
    common_test_record_test_assertion (
        SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST, 3,
        test_result, "response version - 0x%02x", spdm_response->header.spdm_version);
    if (test_result == COMMON_TEST_RESULT_FAIL) {
        return ;
    }
    ...
    common_test_record_test_assertion (
        SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST, 4,
        test_result, "response param1 - 0x%02x", spdm_response->header.param1);
    if (test_result == COMMON_TEST_RESULT_FAIL) {
        return ;
    }
    ...
    common_test_record_test_assertion (
        SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST, 5,
        test_result, "response param2 - 0x%02x", spdm_response->header.param2);
}
...
void spdm_test_case_algorithms_invalid_request (void *test_context)
{
    ...
    for (index = 0; index < 6; index ++) {
        ...
        if (LIBSPDM_STATUS_IS_ERROR(status)) {
            common_test_record_test_assertion (
                SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_INVALID_REQUEST, COMMON_TEST_ID_END,
                COMMON_TEST_RESULT_NOT_TESTED, "send/receive failure");
            continue ;
        }
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_INVALID_REQUEST, 1,
            test_result, "response size - %d", spdm_response_size);
        if (test_result == COMMON_TEST_RESULT_FAIL) {
            continue ;
        }
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_INVALID_REQUEST, 2,
            test_result, "response code - 0x%02x", spdm_response->header.request_response_code);
        if (test_result == COMMON_TEST_RESULT_FAIL) {
            continue ;
        }
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_INVALID_REQUEST, 3,
            test_result, "response version - 0x%02x", spdm_response->header.spdm_version);
        if (test_result == COMMON_TEST_RESULT_FAIL) {
            continue ;
        }
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_INVALID_REQUEST, 4,
            test_result, "response param1 - 0x%02x", spdm_response->header.param1);
        if (test_result == COMMON_TEST_RESULT_FAIL) {
            continue ;
        }
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_INVALID_REQUEST, 5,
            test_result, "response param2 - 0x%02x", spdm_response->header.param2);
    }
}
...
void spdm_test_case_algorithms_success_11 (void *test_context)
{
    ...
    if (LIBSPDM_STATUS_IS_ERROR(status)) {
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_SUCCESS_11, COMMON_TEST_ID_END,
            COMMON_TEST_RESULT_NOT_TESTED, "send/receive failure");
        return ;
    }
    ...
    for (index = 0; index < spdm_response->header.param1; index++) {
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_SUCCESS_11, 12,
    ...
    if (((rsp_cap_flags & SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_KEY_EX_CAP) != 0) &&
        ((dhe_named_group != 0xFFFF) && (dhe_named_group != 0x0))) {
        test_result = COMMON_TEST_RESULT_PASS;
    } else if (((rsp_cap_flags & SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_KEY_EX_CAP) == 0) &&
               (dhe_named_group == 0x0)) {
        test_result = COMMON_TEST_RESULT_PASS;
    } else {
        test_result = COMMON_TEST_RESULT_FAIL;
    ...
    if ((((rsp_cap_flags & SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_KEY_EX_CAP) != 0) ||
         ((rsp_cap_flags & SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_PSK_CAP) != 0)) &&
    ...
    if (((rsp_cap_flags & SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MUT_AUTH_CAP) != 0) &&
        ((req_base_asym_alg != 0xFFFF) && (req_base_asym_alg != 0x0))) {
        test_result = COMMON_TEST_RESULT_PASS;
    } else if (((rsp_cap_flags & SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_MUT_AUTH_CAP) == 0) &&
...
void spdm_test_case_algorithms_success_12 (void *test_context)
{
    ...
    for (index = 0; index < spdm_response->header.param1; index++) {
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_SUCCESS_12, 12,
            test_result, "response alg_count - 0x%02x", struct_table->alg_count);
        ext_alg_count = struct_table->alg_count & 0xF;
        struct_table =
            (void *)((size_t)struct_table +
    ...
    if (((rsp_cap_flags & SPDM_GET_CAPABILITIES_RESPONSE_FLAGS_KEY_EX_CAP) != 0) ||
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_SUCCESS_12, 17,
            test_result, "response other_params_support - 0x%02x", spdm_response->other_params_support);
    }
}
...
void spdm_test_case_algorithms_unexpected_non_identical (void *test_context)
{
    ...
    if (LIBSPDM_STATUS_IS_ERROR(status)) {
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST_NON_IDENTICAL, COMMON_TEST_ID_END,
    ...
    for (index = 0; index < 3; index ++) {
        ...
        case 1:
            ...
            common_test_record_test_message ("test base_asym_algo - 0x%08x, base_hash_algo - 0x%08x\n", base_asym_sel, base_hash_sel);
            break;
        case 2:
            if (version < SPDM_MESSAGE_VERSION_11) {
                continue;
            ...
            common_test_record_test_message ("test dhe_named_group - 0x%04x, aead_cipher_suite - 0x%04x, req_base_asym_alg - 0x%04x\n",
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST_NON_IDENTICAL, 1,
            test_result, "response size - %d", spdm_response_size);
        if (test_result == COMMON_TEST_RESULT_FAIL) {
            continue ;
        }
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST_NON_IDENTICAL, 2,
            test_result, "response code - 0x%02x", spdm_response->header.request_response_code);
        if (test_result == COMMON_TEST_RESULT_FAIL) {
            continue ;
        }
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST_NON_IDENTICAL, 3,
            test_result, "response version - 0x%02x", spdm_response->header.spdm_version);
        if (test_result == COMMON_TEST_RESULT_FAIL) {
            continue ;
        }
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST_NON_IDENTICAL, 4,
            test_result, "response param1 - 0x%02x", spdm_response->header.param1);
        if (test_result == COMMON_TEST_RESULT_FAIL) {
            continue ;
        }
        ...
        common_test_record_test_assertion (
            SPDM_RESPONDER_TEST_GROUP_ALGORITHMS, SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST_NON_IDENTICAL, 5,
            test_result, "response param2 - 0x%02x", spdm_response->header.param2);
    }
}
...
common_test_case_t m_spdm_test_group_algorithms[] = {
    ...
    {SPDM_RESPONDER_TEST_CASE_ALGORITHMS_VERSION_MISMATCH, "spdm_test_case_algorithms_version_mismatch", spdm_test_case_algorithms_version_mismatch, spdm_test_case_algorithms_setup_version_any},
    {SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST, "spdm_test_case_algorithms_unexpected_request", spdm_test_case_algorithms_unexpected_request, spdm_test_case_algorithms_setup_version_only},
    {SPDM_RESPONDER_TEST_CASE_ALGORITHMS_INVALID_REQUEST, "spdm_test_case_algorithms_invalid_request", spdm_test_case_algorithms_invalid_request, spdm_test_case_algorithms_setup_version_any},
    {SPDM_RESPONDER_TEST_CASE_ALGORITHMS_SUCCESS_11, "spdm_test_case_algorithms_success_11", spdm_test_case_algorithms_success_11, spdm_test_case_algorithms_setup_version_11},
    {SPDM_RESPONDER_TEST_CASE_ALGORITHMS_SUCCESS_12, "spdm_test_case_algorithms_success_12", spdm_test_case_algorithms_success_12, spdm_test_case_algorithms_setup_version_12},
    {SPDM_RESPONDER_TEST_CASE_ALGORITHMS_UNEXPECTED_REQUEST_NON_IDENTICAL, "spdm_test_case_algorithms_unexpected_non_identical", spdm_test_case_algorithms_unexpected_non_identical, spdm_test_case_algorithms_setup_version_any},
