...
{
    return spdm_test_case_key_update_ack_setup_session (test_context, 0, NULL, true);
}
...
{
    return spdm_test_case_key_update_ack_setup_session (test_context, 0, NULL, false);
}
