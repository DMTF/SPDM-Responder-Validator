...
{
    return spdm_test_case_end_session_ack_setup_session (test_context, 0, NULL, true);
}
...
{
    return spdm_test_case_end_session_ack_setup_session (test_context, 0, NULL, false);
}
